export default class uiScene extends Phaser.Scene {
  ...
  create() {
    ...
    this.homeButton = this.add.sprite(255, 123, 'homeButton').setInteractive().setFrame(4);
    this.homeButton.on('pointerdown', function (pointer) {
      this.scene.sleep('gameScene');
      this.scene.start('menuScene');
    }.bind(this));

    this.optionButton = this.add.sprite(256, 145, 'optionButton').setInteractive().setFrame(2);
