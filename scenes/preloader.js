export default class preloaderScene extends Phaser.Scene {
  ...
  preload() {
    ...
    */
    ...
    this.load.spritesheet('playButton', 'https://cdn.jsdelivr.net/gh/13ilaurente/csgame@master/assets/buttons/menu_buttons.png', {frameWidth: 30, frameHeight: 20.2});
    this.load.spritesheet('optionButton', 'https://cdn.jsdelivr.net/gh/13ilaurente/csgame@master/assets/buttons/menu_buttons.png', {frameWidth: 30, frameHeight: 20.2});
    this.load.spritesheet('homeButton', 'https://cdn.jsdelivr.net/gh/13ilaurente/csgame@master/assets/buttons/menu_buttons.png', {frameWidth: 30, frameHeight: 20.2});
